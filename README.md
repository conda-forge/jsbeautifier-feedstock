...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsbeautifier-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14391&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsbeautifier-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsbeautifier` can be installed with:

```
conda install jsbeautifier
```

It is possible to list all of the versions of `jsbeautifier` available on your platform with:
